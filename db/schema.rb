...
ActiveRecord::Schema.define(version: 2023_08_27_005106) do
  ...
  create_table "blog_likes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["blog_post_id"], name: "index_blog_likes_on_blog_post_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "membership_level", default: ""
  ...
  add_foreign_key "blog_likes", "blog_posts"
